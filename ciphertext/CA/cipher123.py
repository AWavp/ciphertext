c = int(input("Enter your number you have recent from phase one to enter phase two: "))
n = int(input("Enter options: 1 for rigth or 2 for left: "))
p = int(input("How many shift are you going to do?: "))
